...
contains 
  ...
  subroutine chpldrv_column_physics(tracer_array, nz, nt, &
                                    ...
                                    srflx, Cp, rho0) bind(C,name='chpldrv_column_physics')
    !-----------------------------------------------------------------------
...
subroutine main2
  ...
  print *, 'calling chpldrv_column_physics...'
  call chpldrv_column_physics(tracer_array, nz, nt, sss_ind, sst_ind, &
