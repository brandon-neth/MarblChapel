// Tests that setInteriorTendencyForcingArray writes out a warning correctly
...
var data = for i in 1..10 do i: real;

marblInstance.setInteriorTendencyForcingArray("invalidVariableName", data);
