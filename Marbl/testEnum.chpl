...
use Marbl;
use Marbl.InteriorTendencyForcingIndex;
use Marbl.SurfaceFluxForcingIndex;
use CTypes;
module myNetCDF {
  use NetCDF.C_NetCDF;
  use List;
...
for colIdx_ in tracerArrayDomain.dim[0] {
  ...
  marblWrapper.setSurfaceFluxForcingValue(SurfaceFluxForcingIndex.SurfaceSalinity, salinity[colIdx, 1]);
  marblWrapper.setSurfaceFluxForcingValue(SurfaceFluxForcingIndex.SurfaceTemperature, temperature[colIdx, 1]);
  marblWrapper.setSurfaceFluxForcingValue(SurfaceFluxForcingIndex.U10Sqr, u10_sqr[colIdx]);
  marblWrapper.setSurfaceFluxForcingValue(SurfaceFluxForcingIndex.CO2, atm_co2[colIdx]);
  marblWrapper.setSurfaceFluxForcingValue(SurfaceFluxForcingIndex.CO2Alt, atm_alt_co2[colIdx]);
  marblWrapper.setSurfaceFluxForcingValue(SurfaceFluxForcingIndex.AtmosphericPressure, atm_pressure[colIdx]);
  marblWrapper.setSurfaceFluxForcingValue(SurfaceFluxForcingIndex.DustFlux, dust_flux[colIdx]);
  marblWrapper.setSurfaceFluxForcingValue(SurfaceFluxForcingIndex.IronFlux, iron_flux[colIdx]);
  marblWrapper.setSurfaceFluxForcingValue(SurfaceFluxForcingIndex.NOxFlux, nox_flux[colIdx]);
  marblWrapper.setSurfaceFluxForcingValue(SurfaceFluxForcingIndex.NHyFlux, nhy_flux[colIdx]);
  ...
  marblWrapper.setInteriorTendencyForcingScalar(InteriorTendencyForcingIndex.DustFlux, dust_flux[colIdx]);
  marblWrapper.setInteriorTendencyForcingArray(InteriorTendencyForcingIndex.PotentialTemperature, temperature[colIdx,..]);
  marblWrapper.setInteriorTendencyForcingArray(InteriorTendencyForcingIndex.Salinity, scaledSalinity[colIdx,..]);
  marblWrapper.setInteriorTendencyForcingArray(InteriorTendencyForcingIndex.SurfaceShortwave, surfaceShortwave[colIdx,..]);
  marblWrapper.setInteriorTendencyForcingArray(InteriorTendencyForcingIndex.PARColumnFraction, columnFraction[colIdx,..]);
  marblWrapper.setInteriorTendencyForcingArray(InteriorTendencyForcingIndex.Pressure, pressure[colIdx,..], activeLevelCount[colIdx]);
  marblWrapper.setInteriorTendencyForcingArray(InteriorTendencyForcingIndex.O2ConsumptionScale, o2Factor[colIdx,..], activeLevelCount[colIdx]);
  marblWrapper.setInteriorTendencyForcingArray(InteriorTendencyForcingIndex.IronSedimentFlux, scaledIronSed[colIdx,..], activeLevelCount[colIdx]);
